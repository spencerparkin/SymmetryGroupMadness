...
bool Puzzle::CreateShapes( void )
{
	...
	switch( level )
	{
		...
		case 7:
		{
			...
			pointArray.insert( pointArray.begin(), point );		// Note that order determines our base.

			angle = 4.0 * M_PI / 5.0;
			vertex.set_e1( x + 5.0 * cos( angle ) );
			vertex.set_e2( y + 5.0 * sin( angle ) );
			point = point + 0.93 * ( vertex - point );
			pointArray.insert( pointArray.begin(), point );		// I think we want this very first in the array, because the first step is pairing small diamonds with large ones.
			...
			//wxString code = CalculateAndPrintGenerators( true );
			pointArray.clear();
			...
			R_2.Define( 57, 54 );
			R_2.Define( 58, 55 );
			shape2->ccwRotationPermutation = R_2;
			...
			F0_2.Define( 57, 54 );
			F0_2.Define( 58, 56 );
			shape2->reflectionPermutationArray.push_back( F0_2 );
			...
			F1_2.Define( 57, 55 );
			F1_2.Define( 58, 54 );
			shape2->reflectionPermutationArray.push_back( F1_2 );
			...
			F2_2.Define( 56, 54 );
			F2_2.Define( 58, 55 );
			shape2->reflectionPermutationArray.push_back( F2_2 );
			...
			F3_2.Define( 57, 58 );
			F3_2.Define( 58, 57 );
			shape2->reflectionPermutationArray.push_back( F3_2 );
			...
			F4_2.Define( 56, 57 );
			F4_2.Define( 57, 56 );
			shape2->reflectionPermutationArray.push_back( F4_2 );
